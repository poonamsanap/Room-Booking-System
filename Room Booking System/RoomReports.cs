...
namespace Room_Booking_System
{
    public partial class RoomReports : Form
    {
        ...
        private void RoomReports_Load(object sender, EventArgs e)
        {
            ...
            con.Open();
           // string str = "select R.Room_no,R.Room_type,R.Bed_quantity,R.Capacity,B.To_date from RoomDetails R , Bookings B where R.Room_no = B.Room_no";
            string str = "select Room_no,Room_type,Bed_quantity,Capacity,Amount from RoomDetails ";
